...
var audio_clips = {
	"pistol_shot": preload ("res://gun/gun-20200312T114322Z-001/gun/gun1.wav"), #preload("res://path_to_your_audio_here!")
	"rifle_shot": preload ("res://gun/gun-20200312T114322Z-001/gun/gun2.wav"), #preload("res://path_to_your_audio_here!")
	"gun_cock": preload ("res://gun/gun-20200312T114322Z-001/gun/gun-cocking-03.wav"), #preload("res://path_to_your_audio_here!")
}
